                 ...
                 {paymentMethod === 'cryptocurrency' && (
                  <Fragment>
                    <Col xs={20}>
                      ...
                      <h5>bc1qnjwsgmjk3kt5rjgnxzgz5jqgg6rexzeymdzwqy</h5>
                      <button type="button" class="btn btn-warning round mr-1 mb-0">Copy address</button>
                    </Col>
                     <Col xs={20}>
                      <Label className='form-label' for='cryptocurrency'>
                      ...
                      <h5>0x1edeFE3341A80aDc8a697917d9B77787d0356485</h5>
                      <button type="button" class="btn btn-warning round mr-1 mb-0">Copy address</button>
                    </Col>
